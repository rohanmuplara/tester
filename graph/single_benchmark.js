...
async function benchmarkInputDefininedInCode() {
   ...
   console.log("d");
   await benchmarkInput("https://storage.googleapis.com/uplara_tfjs/newest_rohan/human_binary_graph/model.json", human_binary_mask_inputs, ["human_binary_mask"], 4)
   ...
   console.log("e");
   await benchmarkInput("https://storage.googleapis.com/uplara_tfjs/newest_rohan/human_parsing_graph/model.json", human_parsing_inputs, ["person", "human_parsing_mask"],  4)
   ...
   console.log("f");
   await benchmarkInput("https://storage.googleapis.com/uplara_tfjs/newest_rohan/expected_seg_graph/model.json", expected_seg_inputs, ["expected_seg_mask"], 4)
   ...
   console.log("g");
   await benchmarkInput("https://storage.googleapis.com/uplara_tfjs/newest_rohan/cloth_inpainting_graph/model.json", cloth_inpainting_inputs, ["inpainted_cloth"], 4)
   ...
   console.log("h");
   await benchmarkInput("https://storage.googleapis.com/uplara_tfjs/newest_rohan/skin_inpainting_graph2/model.json", skin_inpainting_inputs, ["person"], 4)
}
