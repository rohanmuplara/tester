async function benchmarkInput (models, num_runs) {
      cloth_graph_outputs = {"cloth_mask": tf.ones([1,256,193,1]), "cloth": tf.ones([1,256,193,1])}
      ...
      let skin_inpainting_output = await runModel(models["sking_inpainting"], {"person": human_parsing_output["person"], "human_parsing_mask": human_parsing_output["human_parsing_mask"], "expected_seg_mask": expected_seg_output["expected_seg_mask"], "inpainted_cloth": cloth_inpainting_output["inpainted_cloth"]}, ["person"], true);
...
async function benchmarkInputDefininedInCode() {
  let model_paths_dict = {"tps": "https://storage.googleapis.com/uplara_tfjs/newest_rohan/tps_graph/model.json", 
               ...
               "denspose":"https://storage.googleapis.com/uplara_tfjs/newest_rohan/denspose_graph/model.json",
